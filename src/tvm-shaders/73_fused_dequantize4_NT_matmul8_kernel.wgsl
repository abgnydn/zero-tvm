// [73] fused_dequantize4_NT_matmul8_kernel (shader #73, 138 lines)
//----------------------------------------
// Function: fused_dequantize4_NT_matmul8_kernel
//----------------------------------------
enable f16;
...
fn fused_dequantize4_NT_matmul8_kernel(
  ...
  for (var ax2_fused_0 : i32 = 0; ax2_fused_0 < 16i; ax2_fused_0++) {
    ...
    if ((i32(blockIdx.y) * 2i) < podArgs.seq_len) {
      NT_matmul_intermediate_pad_rf_local[0i] = fma(lv33[(((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i))], dequantize_local[0i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 1i)], dequantize_local[1i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 2i)], dequantize_local[2i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3i)], dequantize_local[3i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 4i)], dequantize_local[4i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 5i)], dequantize_local[5i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 6i)], dequantize_local[6i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 7i)], dequantize_local[7i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(lv33[(((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i))], dequantize_local[8i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 1i)], dequantize_local[9i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 2i)], dequantize_local[10i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3i)], dequantize_local[11i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 4i)], dequantize_local[12i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 5i)], dequantize_local[13i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 6i)], dequantize_local[14i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 7i)], dequantize_local[15i], NT_matmul_intermediate_pad_rf_local[1i]);
    }
    if (((i32(blockIdx.y) * 2i) + 1i) < podArgs.seq_len) {
      NT_matmul_intermediate_pad_rf_local[2i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8192i)], dequantize_local[0i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8193i)], dequantize_local[1i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8194i)], dequantize_local[2i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8195i)], dequantize_local[3i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8196i)], dequantize_local[4i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8197i)], dequantize_local[5i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8198i)], dequantize_local[6i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8199i)], dequantize_local[7i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8192i)], dequantize_local[8i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8193i)], dequantize_local[9i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8194i)], dequantize_local[10i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8195i)], dequantize_local[11i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8196i)], dequantize_local[12i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8197i)], dequantize_local[13i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8198i)], dequantize_local[14i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(lv33[((((i32(blockIdx.y) * 16384i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 8199i)], dequantize_local[15i], NT_matmul_intermediate_pad_rf_local[3i]);
    }
  }
