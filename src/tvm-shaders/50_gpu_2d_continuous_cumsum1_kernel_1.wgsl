// [50] gpu_2d_continuous_cumsum1_kernel_1 (shader #50, 120 lines)
//----------------------------------------
// Function: gpu_2d_continuous_cumsum1_kernel_1
//----------------------------------------
...
fn gpu_2d_continuous_cumsum1_kernel_1(
  ...
  for (var i_s : i32 = 0; i_s < 4i; i_s++) {
    let rmod : i32 = ((podArgs.n - 1i) % (1i<<u32(((podArgs.i * 9i) + 9i))));
    let rdiv : i32 = ((podArgs.n - 1i) / (1i<<u32(((podArgs.i * 9i) + 9i))));
    var condval : f32;
    if ((((((v__1 * 512i) + (i32(threadIdx.y) * 128i)) + (i32(threadIdx.x) * 4i)) + i_s) <= select((rdiv - 1i), rdiv, ((((1i<<u32(((podArgs.i * 9i) + 9i))) >= 0i) && (rmod >= 0i)) || (((1i<<u32(((podArgs.i * 9i) + 9i))) < 0i) && (rmod <= 0i)))))) {
      condval = Tmp[((((((v__1 * 512i) + (i32(threadIdx.y) * 128i)) + (i32(threadIdx.x) * 4i)) + (i32(blockIdx.y) * podArgs.n)) + (podArgs.i * ((podArgs.n + 511i)>>9u))) + i_s)];
} else {
  ...
  for (var i_s_1 : i32 = 0; i_s_1 < 4i; i_s_1++) {
    let rmod_1 : i32 = ((podArgs.n - 1i) % (1i<<u32(((podArgs.i * 9i) + 9i))));
    let rdiv_1 : i32 = ((podArgs.n - 1i) / (1i<<u32(((podArgs.i * 9i) + 9i))));
    if (((((v__1 * 512i) + (i32(threadIdx.y) * 128i)) + (i32(threadIdx.x) * 4i)) + i_s_1) <= select((rdiv_1 - 1i), rdiv_1, ((((1i<<u32(((podArgs.i * 9i) + 9i))) >= 0i) && (rmod_1 >= 0i)) || (((1i<<u32(((podArgs.i * 9i) + 9i))) < 0i) && (rmod_1 <= 0i))))) {
      Tmp[((((((v__1 * 512i) + (i32(threadIdx.y) * 128i)) + (i32(threadIdx.x) * 4i)) + (i32(blockIdx.y) * podArgs.n)) + (podArgs.i * ((podArgs.n + 511i)>>9u))) + i_s_1)] = shared_buf[(((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i)) + i_s_1)];
    }
  }
  if ((i32(threadIdx.x) == 0i) && (i32(threadIdx.y) == 0i)) {
    Tmp[(((i32(blockIdx.y) * podArgs.n) + ((podArgs.i + 1i) * ((podArgs.n + 511i)>>9u))) + v__1)] = shared_buf[511i];
  }
}
