// [4] batch_prefill_paged_kv_kernel (shader #4, 313 lines)
//----------------------------------------
      ...
      for (var iterator : i32 = 0; iterator < ((kv_chunk_len[0i] + 31i)>>5u); iterator++) {
        for (var lz_0 : i32 = 0; lz_0 < 2i; lz_0++) {
          for (var ly_0_0 : i32 = 0; ly_0_0 < 3i; ly_0_0++) {
            if (((((iterator * 32i) + (lz_0 * 16i)) + (i32(threadIdx.y) * 4i)) + (i32(threadIdx.x)>>3u)) < kv_chunk_len[0i]) {
              let page_no : i32 = page_values[((((iterator * 2i) + lz_0) + cur_page_indptr_begin) + podArgs.page_values_elem_offset)];
              ...
              if ((podArgs.rotary_mode == 1i)) {
                ...
                if ((((ly_0_0 * 2i) + ((i32(threadIdx.x) & 7i)>>2u)) < 3i)) {
                  let v__4 : i32 = ((((((((page_no * 98304i) + (i32(blockIdx.y) * 1536i)) + (i32(threadIdx.y) * 384i)) + ((i32(threadIdx.x)>>3u) * 96i)) + (ly_0_0 * 32i)) + ((i32(threadIdx.x) & 7i) * 4i)) + podArgs.pages_elem_offset) + 48i);
                  condval_4 = (vec4<f16>(pages[v__4 + 0], pages[v__4 + 1], pages[v__4 + 2], pages[v__4 + 3]) * vec4<f16>(-1.000000e+00h, -1.000000e+00h, -1.000000e+00h, -1.000000e+00h));
} else {
                  let v__5 : i32 = ((((((((page_no * 98304i) + (i32(blockIdx.y) * 1536i)) + (i32(threadIdx.y) * 384i)) + ((i32(threadIdx.x)>>3u) * 96i)) + (ly_0_0 * 32i)) + ((i32(threadIdx.x) & 7i) * 4i)) + podArgs.pages_elem_offset) - 48i);
                  condval_4 = vec4<f16>(pages[v__5 + 0], pages[v__5 + 1], pages[v__5 + 2], pages[v__5 + 3]);
}
                let v__6 : i32 = (((((((page_no * 98304i) + (i32(blockIdx.y) * 1536i)) + (i32(threadIdx.y) * 384i)) + ((i32(threadIdx.x)>>3u) * 96i)) + (ly_0_0 * 32i)) + ((i32(threadIdx.x) & 7i) * 4i)) + podArgs.pages_elem_offset);
                condval_3 = vec4<f16>(fma(sin(freq_1), vec4<f32>(condval_4), (cos(freq_1) * vec4<f32>(vec4<f16>(pages[v__6 + 0], pages[v__6 + 1], pages[v__6 + 2], pages[v__6 + 3])))));
} else {
                let v__7 : i32 = (((((((page_no * 98304i) + (i32(blockIdx.y) * 1536i)) + (i32(threadIdx.y) * 384i)) + ((i32(threadIdx.x)>>3u) * 96i)) + (ly_0_0 * 32i)) + ((i32(threadIdx.x) & 7i) * 4i)) + podArgs.pages_elem_offset);
                condval_3 = vec4<f16>(pages[v__7 + 0], pages[v__7 + 1], pages[v__7 + 2], pages[v__7 + 3]);
}
              let v__8 : i32 = (((((lz_0 * 1536i) + (i32(threadIdx.y) * 384i)) + ((i32(threadIdx.x)>>3u) * 96i)) + (ly_0_0 * 32i)) + ((i32(threadIdx.x) & 7i) * 4i));
              K_smem[v__8 + 0] = condval_3[0];
              K_smem[v__8 + 1] = condval_3[1];
              K_smem[v__8 + 2] = condval_3[2];
              K_smem[v__8 + 3] = condval_3[3];
            } else {
        ...
        for (var lz_0_1 : i32 = 0; lz_0_1 < 2i; lz_0_1++) {
          for (var ly_0_0_1 : i32 = 0; ly_0_0_1 < 3i; ly_0_0_1++) {
            if (((((iterator * 32i) + (lz_0_1 * 16i)) + (i32(threadIdx.y) * 4i)) + (i32(threadIdx.x)>>3u)) < kv_chunk_len[0i]) {
              let page_no_1 : i32 = page_values[((((iterator * 2i) + lz_0_1) + cur_page_indptr_begin) + podArgs.page_values_elem_offset)];
              let v__10 : i32 = ((((((((page_no_1 * 98304i) + (i32(blockIdx.y) * 1536i)) + (i32(threadIdx.y) * 384i)) + ((i32(threadIdx.x)>>3u) * 96i)) + (ly_0_0_1 * 32i)) + ((i32(threadIdx.x) & 7i) * 4i)) + podArgs.pages_elem_offset) + 49152i);
        ...
        if (i32(threadIdx.y) < 1i) {
          ...
          for (var j : i32 = 0; j < 32i; j++) {
            ...
            if ((0i < podArgs.causal)) {
              condval_5 = (cse_v7 <= ((((((i32(threadIdx.y) * 32i) + kv_chunk_len[0i]) + q_indptr[(b_idx_1 + podArgs.q_indptr_elem_offset)]) + LH_start) + i32(threadIdx.x)) - q_indptr[((b_idx_1 + podArgs.q_indptr_elem_offset) + 1i)]));
} else {
              condval_5 = (cse_v7 < kv_chunk_len[0i]);
}
            if (condval_5) {
        ...
        for (var j_1 : i32 = 0; j_1 < 32i; j_1++) {
          ...
          if (i32(threadIdx.y) < 1i) {
            ...
            var condval_6 : bool;
            if ((0i < podArgs.causal)) {
              condval_6 = (cse_v8 <= ((((((i32(threadIdx.y) * 32i) + kv_chunk_len[0i]) + q_indptr[(b_idx_1 + podArgs.q_indptr_elem_offset)]) + LH_start) + i32(threadIdx.x)) - q_indptr[((b_idx_1 + podArgs.q_indptr_elem_offset) + 1i)]));
} else {
              condval_6 = (cse_v8 < kv_chunk_len[0i]);
}
            if (condval_6) {
