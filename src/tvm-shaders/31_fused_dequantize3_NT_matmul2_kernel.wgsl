// [31] fused_dequantize3_NT_matmul2_kernel (shader #31, 138 lines)
//----------------------------------------
// Function: fused_dequantize3_NT_matmul2_kernel
//----------------------------------------
enable f16;
...
fn fused_dequantize3_NT_matmul2_kernel(
  ...
  for (var ax2_fused_0 : i32 = 0; ax2_fused_0 < 6i; ax2_fused_0++) {
    ...
    if ((i32(blockIdx.y) * 2i) < podArgs.batch_size) {
      NT_matmul_intermediate_pad_rf_local[0i] = fma(rms_norm196[(((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i))], dequantize_local[0i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 1i)], dequantize_local[1i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 2i)], dequantize_local[2i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3i)], dequantize_local[3i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 4i)], dequantize_local[4i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 5i)], dequantize_local[5i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 6i)], dequantize_local[6i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[0i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 7i)], dequantize_local[7i], NT_matmul_intermediate_pad_rf_local[0i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(rms_norm196[(((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i))], dequantize_local[8i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 1i)], dequantize_local[9i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 2i)], dequantize_local[10i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3i)], dequantize_local[11i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 4i)], dequantize_local[12i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 5i)], dequantize_local[13i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 6i)], dequantize_local[14i], NT_matmul_intermediate_pad_rf_local[1i]);
      NT_matmul_intermediate_pad_rf_local[1i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 7i)], dequantize_local[15i], NT_matmul_intermediate_pad_rf_local[1i]);
    }
    if (((i32(blockIdx.y) * 2i) + 1i) < podArgs.batch_size) {
      NT_matmul_intermediate_pad_rf_local[2i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3072i)], dequantize_local[0i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3073i)], dequantize_local[1i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3074i)], dequantize_local[2i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3075i)], dequantize_local[3i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3076i)], dequantize_local[4i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3077i)], dequantize_local[5i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3078i)], dequantize_local[6i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[2i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3079i)], dequantize_local[7i], NT_matmul_intermediate_pad_rf_local[2i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3072i)], dequantize_local[8i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3073i)], dequantize_local[9i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3074i)], dequantize_local[10i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3075i)], dequantize_local[11i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3076i)], dequantize_local[12i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3077i)], dequantize_local[13i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3078i)], dequantize_local[14i], NT_matmul_intermediate_pad_rf_local[3i]);
      NT_matmul_intermediate_pad_rf_local[3i] = fma(rms_norm196[((((i32(blockIdx.y) * 6144i) + (ax2_fused_0 * 512i)) + (i32(threadIdx.x) * 8i)) + 3079i)], dequantize_local[15i], NT_matmul_intermediate_pad_rf_local[3i]);
    }
  }
